                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                <a href="<?php echo base_url('user/dashboard'); ?>"><i class="ti-dashboard"></i><span>dashboard</span></a>
                                
                            </li>
                            <li>
                                <a href="<?php echo base_url('user/pendaftaran'); ?>"><i class="ti-layout-sidebar-left"></i><span>Pendaftaran</span></a>
                            </li>
                            <li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    <form action="<?php echo base_url(); ?>User/save_df" method="post">
                                    ...
                                    <!--<div class="row">
                                        <div class="col">
                                            ...
                                            <div class="col-sm-9">
                                            <!--<?php
                                                $conn = mysqli_connect('localhost', 'root', '', 'ppdb3');               
                                            ...
                                            <!--<select class="form-control" name="provinsi" id="provinsi">
                                                ...
                                                ?>-->
                                            <!--</select>
                                            <img src="<?php echo base_url(); ?>assets/images/icon/loader.gif" width="35" id="load1" style="display:none;" />
                                            </div>
                                        </div>
                                        </div>
                                        <div class="col">
                                        <div class="form-group">
                                            ...
                                            <img src="<?php echo base_url(); ?>assets/images/icon/loader.gif" width="35" id="load2" style="display:none;" />
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="<?php echo base_url(); ?>assets/images/icon/loader.gif" width="35" id="load3" style="display:none;" />
                                            </div>
                                        </div>
                                        </div>
                                        <div class="col">
